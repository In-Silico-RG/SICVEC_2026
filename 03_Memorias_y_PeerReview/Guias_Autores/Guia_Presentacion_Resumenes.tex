...
\begin{itemize}[label={\textcolor{verdemid}{\textbullet}}]
  \item \textbf{Apertura de convocatoria:} 01 de agosto de 2026
  \item \textbf{Cierre de recepción de resúmenes:} 28 de septiembre de 2026
  \item \textbf{Notificación de aceptación:} 6 de octubre de 2026
...
\subsection{3. Taller Práctico (Workshop)}

Capacitación hands-on con duración de \textbf{90 minutos}.

\textbf{Requisitos:}
\begin{itemize}[label={\textcolor{verdeosc}{\checkmark}}]
  \item Propuesta descriptiva (máximo 500 palabras)
  \item Metodología y recursos requeridos
  \item Capacidad máxima de participantes (recomendado: 25-40)
  \item Facilitador con experiencia en el tema
\end{itemize}

\textbf{Idoneidad:}
\begin{itemize}
  \item Transmisión de habilidades prácticas
  \item Análisis de casos (case studies)
  \item Demostración de tecnologías verdes
  \item Herramientas de innovación circular
\end{itemize}
...
\textbf{Importante:} Solo se aceptarán resúmenes enviados hasta las 23:59 del 28 de septiembre de 2026 (zona horaria Colombia). Envíos posteriores no serán considerados.
\end{tcolorbox}
